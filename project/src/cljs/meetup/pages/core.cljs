(ns meetup.pages.core
  (:require [meetup.config :as config]
            ...
            [meetup.pages.add-schedule :as add-schedule]
            [cljsjs.material-ui]
...
(defmethod page-contents :default
  ...
  [:span [:h1 "404: My basdfad"]
   [:pre.verse "This page should be here, but I never created it."]])


(defn page
  []
  (let [page (:current-page (session/get :route))]
    [:div [navbar/navbar app-routes page]
     ^{:key page} [:div.container [page-contents page]]]))
